...
is( ref $def->in_range([95.0, 100, 108.8]),  'ARRAY',   'check maximal XYZ values');
...
is( ref $def->in_range([96, 0, 0]),         '',   "X value is too big");
is( ref $def->in_range([0, -0.1, 0]),       '',   "Y value is too small");
is( ref $def->in_range([0, 100.1, 0]),      '',   "Y value is too big");
is( ref $def->in_range([0, 0, -.1 ] ),      '',   "Z value is too small");
is( ref $def->in_range([0, 0, 108.9] ),     '',   "Z value is too big");
