...
is( $space->is_long_axis_name('hue'),           1, '"hue" is a long axis name');
is( $space->is_long_axis_name('saturation'),    1, '"saturation" is a long axis name');
is( $space->is_long_axis_name('lightness'),     1, '"lightness" is a long axis name');
is( $space->is_long_axis_name('h'),             0, '"h" is not a long axis name');
is( $space->is_short_axis_name('h'),            1, '"h" is a short axis name');
is( $space->is_short_axis_name('s'),            1, '"s" is a short axis name');
is( $space->is_short_axis_name('l'),            1, '"l" is a short axis name');
is( $space->is_short_axis_name('hue'),          0, '"hue" is not a short axis name');
