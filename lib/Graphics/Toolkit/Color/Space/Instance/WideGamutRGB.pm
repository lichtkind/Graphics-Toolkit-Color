...
# 1, 0.9, 0
# (0,95047 *  1,5298411986) + ( 0,9 * -0,1529595712)
# (0,95047 * -0,5046114854) + ( 0,9 *  1,4225435133)
# (0,95047 *  0,0218442230) + ( 0,9 * -0,0757891912)
# 1,31640455, 0,800671083, -0,047447993
# 1.133149407, 0.903857426, -0.250073162

# 0.1, 0.01, 0.95
# (0,095047 *  1,5298411986) + ( 0,01 * -0,1529595712) + ( 1,0343885 * -0,2765432555)
# (0,095047 * -0,5046114854) + ( 0,01 *  1,4225435133) + ( 1,0343885 * 0,0524182519)
# (0,095047 *  0,0218442230) + ( 0,01 * -0,0757891912) + ( 1,0343885 * 0,9689546693)
# -0.411892768, 0.170684102, 1.001632574
#
