...
# 1, 0.9, 0
# (0,95047 *  1,4032152559) + ( 0,9 * -0,2231400792)
# (0,95047 * -0,5262716028) + ( 0,9 *  1,4816610921)
# (0,95047 * -0,0111904728) + ( 0,9 *  0,0182300474)
# 1,31640455, 0,800671083, -0,047447993
# 1.07177559, 0.903644813, 0.057048425

# 0.1, 0.01, 0.95
# (0,095047 *  1,4032152559) + ( 0,01 * -0,2231400792) + ( 1,0343885 * -0,1015529925)
# (0,095047 * -0,5262716028) + ( 0,01 *  1,4816610921) + ( 1,0343885 *  0,0170313058)
# (0,095047 * -0,0111904728) + ( 0,01 *  0,0182300474) + ( 1,0343885 *  0,9114427432)
# 0.13191899, -0.105951156, 0.967296
#
