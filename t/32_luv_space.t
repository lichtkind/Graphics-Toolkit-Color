...
$luv = $space->deconvert( [ 1, 1, 1], 'CIEXYZ');
...
$xyz = $space->convert( [ 1, .378531073, .534351145 ], 'CIEXYZ');
...
$luv = $space->deconvert( [ 0.433953728, 0.21267, 0.017753001], 'CIEXYZ');
...
$xyz = $space->convert( [ 0.53241, .872923729, .678458015 ], 'CIEXYZ');
...
$luv = $space->deconvert( [ 0.18984292, 0.07217, 0.872771691], 'CIEXYZ');
...
$xyz = $space->convert( [ 0.32297, .351963277, .036862595 ], 'CIEXYZ');
...
$luv = $space->deconvert( [ .214041474 , .21404, 0.214037086], 'CIEXYZ');
is( int @$luv,                         3,  'deconverted gray from CIEXYZ');
is( close_enough( $luv->[0] , 0.53389),          1,  'first value good');
is( close_enough( $luv->[1] , 0.378531073),      1,  'second value good');
is( close_enough( $luv->[2] , 0.534351145),      1,  'third value good');

$xyz = $space->convert( [ 0.53389, .378531073, .534351145 ], 'CIEXYZ');
...
$luv = $space->deconvert( [ 0.057434743, .04125, .190608268], 'CIEXYZ');
...
$xyz = $space->convert( [ 0.24082, .352573446, .317049618 ], 'CIEXYZ');
