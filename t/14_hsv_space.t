...
is( ref $def->in_range([0, 0, 0, 0]),       '',   "HSV got too many values");
...
is( ref $def->in_range([0, 0, -1 ] ),       '',   "value value is too small");
is( ref $def->in_range([0, 0, 1.1] ),       '',   "value value is not integer");
is( ref $def->in_range([0, 0, 101] ),       '',   "value value is too big");
