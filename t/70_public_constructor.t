...
is( ref Graphics::Toolkit::Color->new( ['YUV',1,2]),        '', 'named ARRAY in YUV space got not enough numbers');
is( ref Graphics::Toolkit::Color->new( ['YUV',1,2,3,4]),    '', 'named ARRAY in YUV space got too many numbers');
