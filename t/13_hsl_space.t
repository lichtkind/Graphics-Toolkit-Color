...
is( ref $def->in_range([0, 0, 0, 0]),       '',   "HSL got too many values");
...
is( ref $def->in_range([0, 0, -1 ] ),       '',  "lightness value is too small");
is( ref $def->in_range([0, 0, 1.1] ),       '',  "lightness value is not integer");
is( ref $def->in_range([0, 0, 101] ),       '',  "lightness value is too big");
