...
is( ref $fuchsia_cmy->{'source_tuple'},  'ARRAY',  'found source values');
is( int @{$fuchsia_cmy->{'source_tuple'}},     3,  'CMY has 3 axis');
is( $fuchsia_cmy->{'source_tuple'}[0],         0,  'cyan value is right');
is( $fuchsia_cmy->{'source_tuple'}[1],         1,  'magenta value is right');
is( $fuchsia_cmy->{'source_tuple'}[2],         0,  'yellow value is right');
...
is( ref $blue_hsl->{'source_tuple'},  'ARRAY',  'found source values');
is( int @{$blue_hsl->{'source_tuple'}},     3,  'HSL has 3 axis');
is( $blue_hsl->{'source_tuple'}[0],       2/3,  'hue value is right');
is( $blue_hsl->{'source_tuple'}[1],         1,  'sat value is right');
is( $blue_hsl->{'source_tuple'}[2],       0.5,  'light value is right');
...
is( ref   $blue_hwb->{'source_tuple'},'ARRAY','found source values');
is( int @{$blue_hwb->{'source_tuple'}},     3,  'HSL has 3 axis');
is( $blue_hwb->{'source_tuple'}[0],       2/3,  'hue value is right');
is( $blue_hwb->{'source_tuple'}[1],         0,  'white value is right');
is( $blue_hwb->{'source_tuple'}[2],         0,  'black value is right');
