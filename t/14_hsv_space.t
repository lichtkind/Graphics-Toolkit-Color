...
is( ref $def->is_tuple_in_range([0, 0, 0]),     'ARRAY',   'check HSV values works on lower bound values');
is( ref $def->is_tuple_in_range([360,100,100]), 'ARRAY',   'check HSV values works on upper bound values');
is( ref $def->is_tuple_in_range([0,0]),              '',   "HSV got too few values");
is( ref $def->is_tuple_in_range([0, 0, 0, 0]),       '',   "HSV got too many values");
...
is( ref $def->is_tuple_in_range([0, 0, -1 ] ),       '',   "value value is too small");
is( ref $def->is_tuple_in_range([0, 0, 1.1] ),       '',   "value value is not integer");
is( ref $def->is_tuple_in_range([0, 0, 101] ),       '',   "value value is too big");
